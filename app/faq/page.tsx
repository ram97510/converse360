    ...
    <PageShell scope="standard">
      ...
      <section style={{ background: "var(--color-surface)" }}>
        <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "clamp(48px,7vw,84px) clamp(20px,4vw,32px)", textAlign: "center" }}>
          <h1 style={{ fontSize: "var(--fs-hero)", fontWeight: "var(--fw-hero)", letterSpacing: "-0.04em", lineHeight: "1.06", marginBottom: "20px", maxWidth: "22em", marginLeft: "auto", marginRight: "auto", textWrap: "balance" }}>
      ...
      <section id="faq" style={{ maxWidth: "1440px", margin: "0 auto", padding: "clamp(48px,6.5vw,80px) clamp(20px,4vw,32px)" }}>
        <div style={{ borderTop: "1px solid var(--color-divider)", maxWidth: "60em", margin: "0 auto" }}>
          ...
          <details style={{ borderBottom: "1px solid var(--color-divider)" }}>
            ...
            <p style={{ fontSize: "var(--fs-body)", lineHeight: "1.6", color: "var(--color-text-muted)", padding: "0 0 22px", maxWidth: "44em" }}>Most businesses
          ...
          <details style={{ borderBottom: "1px solid var(--color-divider)" }}>
            ...
            <p style={{ fontSize: "var(--fs-body)", lineHeight: "1.6", color: "var(--color-text-muted)", padding: "0 0 22px", maxWidth: "44em" }}>In most cases
          ...
          <details style={{ borderBottom: "1px solid var(--color-divider)" }}>
            ...
            <p style={{ fontSize: "var(--fs-body)", lineHeight: "1.6", color: "var(--color-text-muted)", padding: "0 0 22px", maxWidth: "44em" }}>It hands the
          ...
          <details style={{ borderBottom: "1px solid var(--color-divider)" }}>
            ...
            <p style={{ fontSize: "var(--fs-body)", lineHeight: "1.6", color: "var(--color-text-muted)", padding: "0 0 22px", maxWidth: "44em" }}>Yes. Your whole
          ...
          <details style={{ borderBottom: "1px solid var(--color-divider)" }}>
            ...
            <p style={{ fontSize: "var(--fs-body)", lineHeight: "1.6", color: "var(--color-text-muted)", padding: "0 0 22px", maxWidth: "44em" }}>Your
      ...
      <section style={{ background: "var(--brand)", color: "var(--color-bg)" }}>
        <div style={{ maxWidth: "1440px", margin: "0 auto", padding: "clamp(48px,6.5vw,76px) clamp(20px,4vw,32px)", display: "flex", flexDirection: "column", flexWrap: "wrap", alignItems: "center", gap: "24px", textAlign: "center" }}>
          <div>
            ...
            <p style={{ fontSize: "var(--fs-lede)", color: "rgba(255,255,255,0.85)" }}>Ask us directly. We usually reply within one
              business day.</p>
          </div>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "14px" }}>
            <Hx link className="btn-fx btn-fx-dark" href="/contact" style={{ background: "var(--color-bg)", color: "var(--color-text)", fontSize: "16px", fontWeight: "700", padding: "16px 30px", borderRadius: "999px" }} hoverStyle={{ background: "var(--color-surface)" }}>Talk to our Expert</Hx>
